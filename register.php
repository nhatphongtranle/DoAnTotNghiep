                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  <form class="mx-1 mx-md-4" action="add.php" method="post">
                    ...
                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                      <input type="submit" value="Register" name="register" class="btn btn-warning btn-lg bg-black text-light my-2 py-3" style="width:100% ; border-radius: 30px; font-weight:600; border:none;" style="border-radius:25px ;" />
                    </div>
                  </form>
                  <p align="center">i have already account! <a href="index.php" class="text-dark" style="font-weight:700; text-decoration:none;">LOGIN</a></p>
                </div>
                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                  <img src="icons/signup.png" class="img-fluid" alt="Sample image" height="300px" width="500px">
                </div>
              </div>
            </div>
          </div>
